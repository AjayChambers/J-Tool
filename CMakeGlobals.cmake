...
cache_path(
  ...
  "Directory where static libraries are built & stored."
  FORCE)

cache_path(
  JT_ARCHIVE_LIB_DIR
  ${JT_STATIC_LIB_DIR}
  "Directory where archive libraries are built & stored."
  FORCE)

cache_path(
  JT_DYNAMIC_LIB_DIR
  ${JT_STATIC_LIB_DIR}
  "Directory where dynamic libraries are built & stored."
  FORCE)